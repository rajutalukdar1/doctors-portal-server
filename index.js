...
const stripe = require("stripe")(process.env.SECRET_KYE);
...
function verifyJWT(req, res, next) {
    // console.log('pera', req.headers.authorization);
    ...
    try {
        ...
        app.get('/appointmentOptions', async (req, res) => {
            ...
            options.forEach(option => {
                ...
                // console.log('booked', optionBooked);
        ...
        app.get('/bookings', async (req, res) => {
            ...
            // console.log('errorToken', req.query.email);
